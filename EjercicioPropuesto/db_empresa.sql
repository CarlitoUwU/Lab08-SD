...
CREATE USER 'sd_user'@'%' IDENTIFIED BY '123456789@';
...
INSERT INTO Departamento (Nombre, Telefono, Fax) VALUES
  ('Desarrollo de Software', '9001234567', '0000000001'),
  ('Infraestructura',        '9007654321', '0000000002'),
  ('Administración',         '9005555555', '0000000003');

INSERT INTO Ingeniero (IDDpto, Nombre, Apellido, Especialidad, Cargo) VALUES
  (1, 'Miguel',  'Lopez',    'Backend',         'Desarrollador Senior'),
  (1, 'Sofia',   'Perez',    'Frontend',        'Líder de UI/UX'),
  (2, 'Diego',   'Ramirez',  'Redes',           'Administrador de Redes'),
  (2, 'Valeria', 'Torres',   'Servidores',      'Especialista DevOps');

INSERT INTO Proyecto (Nombre, Fec_Inicio, Fec_Termino) VALUES
  ('Sistema de Inventario',      '2025-04-01', '2025-10-31'),
  ('Actualización de Servidores','2025-06-03', NULL),
  ('Portal de Empleados',        '2025-02-01', '2025-04-15');

INSERT INTO Asignacion (IDIng, IDProy, Rol_Proyecto) VALUES
  (1, 1, 'Líder Técnico'),
  (2, 1, 'Diseñadora UI/UX'),
  (3, 2, 'Administrador Principal'),
  (4, 2, 'Especialista en Infraestructura');
  (1, 3, 'Desarrollador Principal'),
  (2, 3, 'Coordinadora de Proyecto'),
